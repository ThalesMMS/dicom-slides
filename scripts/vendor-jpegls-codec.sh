...
printf '%s  %s\n%s  %s\n' \
    'c8ef100ac02552c692d59e60f61ab9dc84f355a62386d571e3db2c1046aa1f5a' "$temporary/package/dist/charlswasm_decode.js" \
    'a8b192966b58218713ac09750a6bf6560d22fe12906600b88fcd49ff0d001e04' "$temporary/package/dist/charlswasm_decode.wasm" \
    | sha256sum --check -
